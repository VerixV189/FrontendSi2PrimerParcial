...
export default function SignInForm() {
  ...
  const navigate = useNavigate();
    ...
    //evento cuando se presiona el raton
    const handleButtonClick = (event: React.MouseEvent) => {
      // Aquí puedes llamar a handleSubmit si el botón hace clic en el formulario
      handleSubmit(event as unknown as React.FormEvent<HTMLFormElement>); // Forzar el tipo del evento
    };
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div>
                  <Button onClick={() => handleButtonClick} className="w-full" size="sm">
                    Login
                  </Button>
                </div>
              </div>
